...
struct Vertex {
    ...
    glm::ivec4 boneIndices; // Indices of the bones affecting this vertex
    glm::vec4 boneWeights;  // Weights of the bones affecting this vertex
    ...
    bool operator==(const Vertex &other) const {
        return position == other.position && color == other.color && tex_coord == other.tex_coord &&
               normal == other.normal && boneIndices == other.boneIndices && boneWeights == other.boneWeights;
    }
};
